...
export default function Home() {
  ...
  <p className="mb-4">
    You&apos;ll find more than just pizza at the top restaurants in Brooklyn. Try some of the local top dishes for a treat. Dont miss the chance to try the popular Cheese Pizza. It&apos;s a classic for a reason.
  </p>
  <p className="mb-4">
